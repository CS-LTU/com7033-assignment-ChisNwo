from werkzeug.security import generate_password_hash, \
    check_password_hash  # For keeping passwords safe, I use "werkzeug.security" - it turns passwords into secret code.
from db_creation import get_db_connection, \
    get_mongodb_connection  # From db_setup I get functions that help me connect to my databases.
